...
panels = [
    ("testA_v2_noisy",   "testA_v2_smooth", "Noisy input",         "Smoothed",        "Test A: Pure smoothing"),
    ("testB_v2_initial", "testB_v2_ortho",  "Initial (algebraic)", "Orthogonalized",  "Test B: Curved bottom wall"),
]
