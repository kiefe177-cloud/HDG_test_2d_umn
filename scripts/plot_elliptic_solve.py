...
panels = [
    ("testA_solve_noisy",   "testA_solve_smooth", "Noisy input",         "Smoothed",        "Test A: Pure smoothing"),
    ("testB_solve_initial", "testB_solve_smooth", "Initial (algebraic)", "Smoothed",        "Test B: Curved bottom wall"),
]
