...
panels = [
    ("testA_noisy",   "testA_smooth", "Noisy input",         "Smoothed",        "Test A: Pure smoothing"),
    ("testB_initial", "testB_ortho",  "Initial (algebraic)", "Orthogonalized",  "Test B: Curved bottom wall"),
]
